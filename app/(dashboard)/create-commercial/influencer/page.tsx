...
type Step = 'influencer' | 'videotype' | 'product' | 'prompt'

export default function InfluencerCommercialPage() {
  const [step, setStep] = useState<Step>('influencer')
        ...
        <div className="cv-initial">
          ...
          <div className="cv-init-chat">
            <div className="cv-chat-row">
              <div className="cv-ref-block" style={{ width: 100, minHeight: 140 }} onClick={openPicker}>
